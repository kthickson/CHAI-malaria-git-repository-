...
home_coordinate_data_out<-data.frame(data4$Lon_EA_HOME_distance,data4$lat_EA_HOME_distance)
travel_coordinate_data_out<-data.frame(data4$lon_to,data4$lat_to)
...
data4<-data.frame(data4,distance_out)
...
data4_with_distance_selected_age<-  factor(data4_with_distance$age_class, levels=c('1','2','3','4','5','6','7')) 
...
distance_and_meanstravel_continuous_distribution<- ggplot() +
  ...
  geom_density(data=data4_with_distance_meanstravel_NA,aes(x=data4_with_distance_meanstravel_NA$distance_out,color="NA")) +
...
data4_age_class5<-subset(data4_with_distance,age_class==5)
data4_age_class6<-subset(data4_with_distance,age_class==6)
data4_age_class_not_5_or_6<-subset(data4_with_distance,age_class!=5&age_class!=6)
library(ggplot2)
...
stargazer (data4_with_distance[c("Malaria_0_1","distance_out")], data4[c("Malaria_0_1","TYPE","Travel_in_out","Country","nightsaway", 
