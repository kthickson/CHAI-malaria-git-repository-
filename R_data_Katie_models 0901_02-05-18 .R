...
travel_prevalence_time.OUT
summary(travel_prevalence_time.OUT)
coef.travel_prevalence_time.OUT<-coef(travel_prevalence_time.OUT)
coef.travel_prevalence_time.OUT
exp.travel_prevalence_time.OUT<- exp(coef(travel_prevalence_time.OUT))
exp.travel_prevalence_time.OUT
confint(travel_prevalence_time.OUT, level=0.95)
conf.travel_prevalence_time.OUT<-exp(confint(travel_prevalence_time.OUT, level=0.95))
conf.travel_prevalence_time.OUT
...
coef.time_binary_age.OUT<-coef(time_binary_age.OUT)
exp.time_binary_age.OUT<-exp(coef(time_binary_age.OUT))
confint(time_binary_age.OUT, level=0.95)
conf.time_binary_age.OUT<-exp(confint(time_binary_age.OUT))
...
time_binary_gender.OUT
summary(time_binary_gender.OUT)
coef.time_binary_gender.OUT<-coef(time_binary_gender.OUT)
exp.time_binary_gender.OUT<-exp(coef(time_binary_gender.OUT))
confint(time_binary_gender.OUT, level=0.95)
conf.time_binary_gender.OUT<-exp(confint(time_binary_gender.OUT))
...
confint(time_binary_reason_travel.OUT, level=0.95) 
conf.time_binary_reason_travel.OUT<-exp(confint(time_binary_reason_travel.OUT)) 
...
time_binary_means_travel.OUT
summary(time_binary_means_travel.OUT) 
coef.time_binary_means_travel.OUT<-coef(time_binary_means_travel.OUT) 
exp.time_binary_means_travel.OUT<-exp(coef(time_binary_means_travel.OUT)) 
confint(time_binary_means_travel.OUT, level=0.95) 
conf.time_binary_means_travel.OUT<-exp(confint(time_binary_means_travel.OUT)) 

time_binary_pop_HOME.OUT<-glm(as.factor(High.risk.month)
                       ~ pop.HOME, data = data4, family=binomial(link=logit))
time_binary_pop_HOME.OUT
summary(time_binary_pop_HOME.OUT) 
coef.time_binary_pop_HOME.OUT<-coef(time_binary_pop_HOME.OUT) 
exp.time_binary_pop_HOME.OUT<-exp(coef(time_binary_pop_HOME.OUT)) 
confint(time_binary_pop_HOME.OUT, level=0.95) 
conf.time_binary_pop_HOME.OUT<-exp(confint(time_binary_pop_HOME.OUT)) 
...
time_binary_pop_urban_rural_distance.OUT
summary(time_binary_pop_urban_rural_distance.OUT) 
coef.time_binary_pop_urban_rural_distance.OUT<-coef(time_binary_pop_urban_rural_distance.OUT) 
exp.time_binary_pop_urban_rural_distance.OUT<-exp(coef(time_binary_pop_urban_rural_distance.OUT)) 
confint(time_binary_pop_urban_rural_distance.OUT, level=0.95) 
conf.time_binary_pop_urban_rural_distance.OUT<-exp(confint(time_pop_urban_rural_distance.OUT)) 

time_binary_distance.OUT<-glm(as.factor(High.risk.month)
                                              ~ distance_out, data = data4, family=binomial(link=logit))
time_binary_distance.OUT
summary(time_binary_distance.OUT) 
coef.time_binary_distance.OUT<-coef(time_binary_distance.OUT) 
exp.time_binary_distance.OUT<-exp(coef(time_binary_distance.OUT)) 
confint(time_binary_distance.OUT, level=0.95) 
conf.time_binary_distance.OUT<-exp(confint(time_binary_distance.OUT)) 

time_binary_country.OUT<-glm(as.factor(High.risk.month)
                              ~ Country, data = data4, family=binomial(link=logit))
time_binary_country.OUT
summary(time_binary_country.OUT) 
coef.time_binary_country.OUT<-coef(time_binary_country.OUT) 
exp.time_binary_country.OUT<-exp(coef(time_binary_country.OUT)) 
confint(time_binary_country.OUT, level=0.95) 
conf.time_binary_country.OUT<-exp(confint(time_binary_country.OUT)) 

time_binary_border_post.OUT<-glm(as.factor(High.risk.month)
                                 ~ data4_selected_BorderPost, data = data4, family=binomial(link=logit))
time_binary_border_post.OUT
summary(time_binary_border_post.OUT) 
coef.time_binary_border_post.OUT<-coef(time_binary_border_post.OUT) 
exp.time_binary_border_post.OUT<-exp(coef(time_binary_border_post.OUT)) 
confint(time_binary_border_post.OUT, level=0.95) 
conf.time_binary_border_post.OUT<-exp(confint(time_binary_border_post.OUT)) 

time_binary_duration.OUT<-glm(as.factor(High.risk.month)
                                 ~ nightsaway, data = data4, family=binomial(link=logit))
time_binary_duration.OUT
summary(time_binary_duration.OUT) 
coef.time_binary_duration.OUT<-coef(time_binary_duration.OUT) 
exp.time_binary_duration.OUT<-exp(coef(time_binary_duration.OUT)) 
confint(time_binary_duration.OUT, level=0.95) 
conf.time_binary_duration.OUT<-exp(confint(time_binary_duration.OUT)) 
...
Month.travel_relevel<-relevel(as.factor(data4$Month.travel.name), ref="Jan") # base month against which to compare probability of travel during each other month (for each variable, e.g. each age class)
time_distance.OUT<-multinom(Month.travel_relevel~ distance_out, data = data4) 
summary(time_distance.OUT)
coef.time_distance.OUT<-coef(time_distance.OUT) #stand alone coefficients of model 
summary(time_distance.OUT)$standard.errors #stand alone standard errors of model
exp.time_distance.OUT<-exp(coef(time_distance.OUT)) 
confint(time_distance.OUT,level = 0.95)
conf.time_distance.OUT<-exp(confint(time_distance.OUT))
time_distance.OUT_zvalues<-summary(time_distance.OUT)$coefficients/summary(time_distance.OUT)$standard.errors #gives z values
time_distance.OUT_zvalues
time_distance.OUT_pvalues<-pnorm(abs(time_pop_urban_rural_distance.OUT_zvalues), lower.tail=FALSE)*2#gives p values 
time_distance.OUT_pvalues
time_distance.OUT_signif <- symnum(time_distance.OUT_pvalues, corr = FALSE, na = FALSE, 
                                                   cutpoints = c(0, 0.001, 0.01, 0.05, 0.1, 1), symbols = c("***", "**", "*", ".", " "), legend = TRUE ) #gives significance stars
paste(time_distance.OUT_pvalues,time_distance.OUT_signif, sep = " ")# gives table with p values and significance stars
...
stargazer (malaria_time.OUT, type = "html", title = "Coefficients, standard error and significance of t / z values for univariate logistic models of variables affecting malaria incidence", style = "default", 
...
stargazer (data4_malarianegative[c("Malaria_0_1","TYPE","Travel_in_out","Country","nightsaway", 
                   ...
                   "BorderPost","Age","age_class","Gender", "Occupation", "Occupation_code", "HOME_urban_rural_distance..degrees.",
                   "pop.HOME", "falciparum_travel_prevalence","Lon_EA_HOME","lat_EA_HOME","lon_to", "lat_to", "distance_out")], type = "html", 
           title = "Summary statistics for all malaria negative individuals surveyed who travelled outside of Swaziland", style = "default", 
           summary = NULL, out = "summary_stats_data4_malarianegative.html", out.header = FALSE,
           column.labels = NULL, column.separate = NULL,
           covariate.labels = NULL, dep.var.caption = "",
           dep.var.labels = NULL, dep.var.labels.include = FALSE,star.cutoffs = c( 0.05, 0.01, 0.001),
           notes = "", notes.align = "l")
stargazer (data4_malariapositive[c("Malaria_0_1","TYPE","Travel_in_out","Country","nightsaway", 
                                   ...
                                   "BorderPost","Age","age_class","Gender", "Occupation", "Occupation_code", "HOME_urban_rural_distance..degrees.",
                                   "pop.HOME", "falciparum_travel_prevalence","Lon_EA_HOME","lat_EA_HOME","lon_to", "lat_to", "distance_out")], type = "html", 
           title = "Summary statistics for all malaria positive individuals surveyed who travelled outside of Swaziland", style = "default", 
           summary = NULL, out = "summary_stats_data4_malariapostitive.html", out.header = FALSE,
           column.labels = NULL, column.separate = NULL,
           covariate.labels = NULL, dep.var.caption = "",
           dep.var.labels = NULL, dep.var.labels.include = FALSE,star.cutoffs = c( 0.05, 0.01, 0.001),
           notes = "", notes.align = "l")
stargazer (subset(data4,High.risk.month==1)[c("Malaria_0_1","TYPE","Travel_in_out","Country","nightsaway", 
           ...
           summary = NULL, out = "summary_stats_data4_high_risk.html", out.header = FALSE,
           column.labels = NULL, column.separate = NULL,
           covariate.labels = NULL, dep.var.caption = "",
           dep.var.labels = NULL, dep.var.labels.include = FALSE,star.cutoffs = c( 0.05, 0.01, 0.001),
           notes = "", notes.align = "l")
stargazer (subset(data4,High.risk.month==0)[c("Malaria_0_1","TYPE","Travel_in_out","Country","nightsaway", 
           ...
           summary = NULL, out = "summary_stats_data4_low_risk.html", out.header = FALSE,
           column.labels = NULL, column.separate = NULL,
           covariate.labels = NULL, dep.var.caption = "",
           dep.var.labels = NULL, dep.var.labels.include = FALSE,star.cutoffs = c( 0.05, 0.01, 0.001),
           notes = "", notes.align = "l")
...
library(ggmap)
zambia_coordinates <- c(lon = 30.744645, lat = -10.869654)
import_map<-get_map(location=zambia_coordinates,zoom=4, maptype = "satellite", source = "google")
